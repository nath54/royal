...
cnbp=[1          ,1           ,1          ,2          ,1          ,1            ,1           ,1          ,1          ,5           ,1               ,1          ,1               ]
cimg=["te1.png"  ,"te2.png"   ,"c0.png"   ,"c1.png"   ,"c2.png"   ,"c6.png"     ,"c3.png"    ,"c4.png"   ,"c5.png"   ,"c7.png"    ,"c8.png"        ,"c9.png"   ,"c10.png"       ]
ctxx=[75/1200*tex,100/1200*tex,50/1200*tex,50/1200*tex,50/1200*tex,50/1200*tex  ,100/1200*tex,50/1200*tex,50/1200*tex,50/1200*tex ,50/1200*tex     ,75/1200*tex,50/1200*tex     ]
ctyy=[75/1000*tey,100/1000*tey,50/1000*tey,50/1000*tey,50/1000*tey,50/1000*tey  ,100/1000*tey,50/1000*tey,50/1000*tey,50/1000*tey ,50/1000*tey     ,75/1000*tey,50/1000*tey     ]
nctxx,nctyy=[],[]
...
def botpc(j,aa):
    ...
    if j.elixir>celi[j.cartactu[j.cartselec]]:
        if j.camp==2:
            ...
            for x in range(cnbp[j.cartactu[j.cartselec]]): carts2.append(Carte(xx-x*10,yy-50*x,j.cartactu[j.cartselec],2))
        ...
        if event.type==QUIT:
            ...
            if pos[0] >= 0 and pos[0] <= tpx and pos[1] >= tpy/2:
                if j1.cartselec != None and j1.elixir >= celi[j1.cartactu[j1.cartselec]]:
                    for x in range(cnbp[j1.cartactu[j1.cartselec]]): carts1.append( Carte(pos[0]-10*x,pos[1]-50*x,j1.cartactu[j1.cartselec],1) )
